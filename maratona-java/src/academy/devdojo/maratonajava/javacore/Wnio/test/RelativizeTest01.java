...
public class RelativizeTest01 {
    public static void main(String[] args) {
        ...
        Path relativo2 = Paths.get("temp/temp.1235");
        ...
        System.out.println("6 "+absoluto1.relativize(relativo1)); // lança excessão pq o java volta para a raiz do projeto (caminho absoluto) e não sabe para onde ir, visto que o caminho é relativo
    }
}
