...
//        searchPricesAsyncFuture(storeService);
    ...
    private static void searchPricesSync(StoreService storeService){
        ...
        System.out.printf("Time test to searchPricesSync %dms%n",(end-start));
...
//            System.out.println(pricesAsyncFuture3.get());
            ...
            System.out.println(pricesAsyncFuture0.join()); // vantagem do join é que ele não lança excessão, deixando o código um pouco mais limpo
