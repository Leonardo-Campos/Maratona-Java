    ...
    public void run() {
        ...
        try{
            if(lock.isHeldByCurrentThread()){
                System.out.printf("Thread %s entrou em uma sessão critica%n",name); // %s = substitui tudo pelo que coloquei depois "name"
            }
            System.out.printf("%d Threads esperando na fila%n",lock.getQueueLength());//%n pula uma linha
